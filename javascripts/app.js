...
(this.require.define({
  ...
  exports.NewTodoView = (function(_super) {
    ...
    NewTodoView.prototype.createOnEnter = function(event) {
      ...
      number = $('.todo-content').last().text();
      $('#holder').load('/toggle/' + number + '/' + '1');
...
(this.require.define({
  ...
  exports.TodoView = (function(_super) {
    ...
    TodoView.prototype.events = {
      ...
      'click .check': 'tableReady',
      'dblclick .todo-content': 'edit',
      'click .todo-destroy': 'clear',
      'keypress .todo-input': 'updateOnEnter',
      'click #logo-sm>img': 'linkHome'
    };
    ...
    TodoView.prototype.linkHome = function() {
    ...
    TodoView.prototype.tableReady = function() {
      var number;
      console.log('foo');
      number = this.model.attributes.content;
      console.log(number);
      return $('#holder').load('/toggle/' + number + '/' + '2');
    };
...
(this.require.define({
  ...
  return (function() {
    ...
    (function() {
      ...
      _print(_safe('<div class="container">\n<center><div id="horizlogo" class="sixteen columns"><img src="../images/logo_horiz.png"></div></center>\n</div>\n<div class="container">\n<div id="todo-app">\n</div>\n</div>\n</div>\n'));
...
(this.require.define({
  ...
  return (function() {
    ...
    (function() {
      ...
      _print(_safe('<div class="container" div id="sixteen-columns">\n<div class="one-third column">\n<input id="new-todo" placeholder="Party Size" type="number" maxlength=10>\n</div>\n<div class="one-third column">\n<input id="new-todo" column" placeholder="Name" type="number" maxlength=10>\n</div>\n<div class="one-third column">\n<input id="new-todo" column" placeholder="Phone Number" type="number" maxlength=10>\n</div>\n<div class="ui-tooltip-top">Press Enter to save this number</div>\n</div>'));
